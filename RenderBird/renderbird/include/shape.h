...
namespace RenderBird
{
	...
	{
	public:
		virtual Float Pdf(const Matrix4f& localToWorld, const RayHitInfo& hitInfo, SurfaceSample* ss, const Vector3f& wi) = 0;
		virtual Float GetArea() = 0;
		virtual bool Sample(const Vector2f& rand2d, LightSample* ls, Float* pdf) = 0;
